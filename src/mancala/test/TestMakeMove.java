...
class TestMakeMove {
	...
	void setUp() throws Exception {
		gameState = new MancalaGameState(true, false, new short[] {0, 14, 4, 4, 4, 4, 4, 0, 4, 4, 4, 4, 4, 4});
		
		gameStateMinimizer = new MancalaGameState(false, false, new short[] {0, 4, 4, 4, 4, 4, 4, 0, 14, 4, 4, 4, 4, 4});
	}
